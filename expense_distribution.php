                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="right">
                                    ...
                                    if ($total > 0) {
                                        ?>
                                        <b class="x"> &#8377 <?php echo $total; ?></b>
                                        <?php
                                    } else if ($total < 0) {
                                        ?>
                                        <b class="y">Overspent by &#8377 <?php echo $total; ?></b>
                                        <?php
                                    } else {
                                        ?>
                                        <b class="z">&#8377 <?php echo $total; ?></b>
                                    <?php }
                                    ?>
                                </div>
                                <br>
                                ...
                                while ($names) {
                                    ...
                                    <div class="right">
                                        ...
                                        if ($share > 0) {
                                            ?>
                                            <b class="x"> Gets back &#8377 <?php echo $share; ?></b>
                                            <?php
                                        } else if ($share < 0) {
                                            ?>
                                            <b class="y"> Owes &#8377 <?php echo $share; ?></b>
                                            <?php
                                        } else {
                                            ?>
                                            <b class="z"> All Settled up</b>
                                        <?php }
                                        ?>
